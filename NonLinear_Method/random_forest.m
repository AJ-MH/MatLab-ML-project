...
% Load the dataset
time_data = readmatrix('All_NonLinear_Features.xlsx'); % Assuming your data is stored as table
...
% Write to Excel
xlswrite('RandomForest_Metrics_NonLinear.xlsx', final_metrics);

disp('Metrics saved to RandomForest_Metrics_NonLinear.xlsx');
