...
folderPath = 'C:\Users\AJ\Downloads\Kan_AJ\MatLab Simulations\March10s\HealthControl_Without_Normalization\HealthControl_mat_all_files';
...
% Write to Excel
xlswrite('HealthControlWithoutNormalization_BubbleEntropy_Features.xlsx', bubble_entropy_final);
xlswrite('HealthControlWithoutNormalization_SampleEntropy_Features.xlsx', sample_entropy_final);
