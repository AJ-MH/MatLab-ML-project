...
writetable(metrics_table, 'BayesianOptimizationSVM_Metrics_BubbleAndSample.xlsx', 'Sheet', 1);
disp('Metrics saved to BayesianOptimizationSVM_Metrics_BubbleAndSample.xlsx');