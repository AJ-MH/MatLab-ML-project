...
% Make predictions
predictions = predict(DTModel, X_test);
...
% Display results
fprintf('Results for Decision Tree and each class label:\n');
...
writetable(metrics_table, 'DecisionTree_Metrics_BubbleAndSample.xlsx', 'Sheet', 1);
disp('Metrics saved to DecisionTree_Metrics_BubbleAndSample.xlsx');
