...
clear all
close all
fileName = 'All_Named_UnNormalized_SampleEntropy_Features.xlsx'; % Replace with your file name
...
a1_band_mean_sample= mean(data1);
a2_band_mean_sample = mean(data2);
a3_band_mean_sample= mean(data3);
a4_band_mean_sample= mean(data4);
d1_band_mean_sample= mean(data5);
d2_band_mean_sample = mean(data6);
d3_band_mean_sample= mean(data7);
d4_band_mean_sample= mean(data8);
a1_band_sd_sample= std(data1);
a2_band_sd_sample = std(data2);
a3_band_sd_sample= std(data3);
a4_band_sd_sample= std(data4);
d1_band_sd_sample= std(data5);
d2_band_sd_sample = std(data6);
d3_band_sd_sample= std(data7);
d4_band_sd_sample= std(data8);
...
p_values_filename = 'p_values_SampleEn.xlsx';
...
means = [a1_band_mean_sample; a2_band_mean_sample; a3_band_mean_sample; a4_band_mean_sample; ...
         d1_band_mean_sample; d2_band_mean_sample; d3_band_mean_sample; d4_band_mean_sample; ...
         ];

stds = [a1_band_sd_sample; a2_band_sd_sample; a3_band_sd_sample; a4_band_sd_sample; ...
        d1_band_sd_sample; d2_band_sd_sample; d3_band_sd_sample; d4_band_sd_sample; ...
        ];

% Define row labels for Mean & Std
feature_names = {'a1_band_mean_sample', 'a2_band_mean_sample', 'a3_band_mean_sample', 'a4_band_mean_sample', ...
                 'd1_band_mean_sample', 'd2_band_mean_sample', 'd3_band_mean_sample', 'd4_band_mean_sample', ...
                 'a1_band_sd_sample', 'a2_band_sd_sample', 'a3_band_sd_sample', 'a4_band_sd_sample', ...
                 'd1_band_sd_sample', 'd2_band_sd_sample', 'd3_band_sd_sample', 'd4_band_sd_sample', ...
                 };
...
mean_std_filename = 'mean_std_SampleEn.xlsx';
